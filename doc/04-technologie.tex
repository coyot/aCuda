...
\section{Testowanie}
W ramach projektu wykorzystane zostały \emph{testy jednostkowe} (\emph{unit testing}), które miały zagwarantować poprawność podstawowych części składowych systemu.
...
\subsubsection{Pex\label{04:pex}}
