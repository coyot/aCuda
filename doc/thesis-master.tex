...
\title{Adaptacja i implementacja algorytmów odkrywania reguł asocjacyjnych z wykorzystaniem procesorów kart graficznych za pomocą technologii CUDA}                   % Note how we protect the final title phrase from breaking
...
\input{02-teoria.tex}
\input{03-cuda.tex}
\input{04-technologie.tex}
\input{05-algorytm.tex}
\input{06-eksperymenty.tex}
\input{07-zakonczenie.tex}
