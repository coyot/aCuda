...
\title{Rownolegle reguly asocjacyjne oraz ich implementacja na procesory graficzne w technologii CUDA}                   % Note how we protect the final title phrase from breaking
